package com.pnot0.magia.registry;

import com.pnot0.magia.Magia;
import com.pnot0.magia.item.ChangeGuiPresetItem;
import com.pnot0.magia.item.EyeItem;
import com.pnot0.magia.item.GuiAdvanceItem;
import com.pnot0.magia.item.GuiReturnItem;
import com.pnot0.magia.item.GuiSummonItem;
import com.pnot0.magia.item.SacredKnife;
...
public class ModItemRegister {
    public static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(Magia.MODID);
    
    public static final DeferredItem<BlockItem> EXAMPLE_BLOCK_ITEM = ITEMS.registerSimpleBlockItem("example_block", Magia.EXAMPLE_BLOCK);
